...
This will create a copy of the repository at ``https://github.com/<username>/scipy2023_sprints_first_PR``
...
You can use HTTPS:
    ...
    git clone -o <username> https://github.com/<username>/scipy2023_sprints_first_PR
...
With ssh set up, you can use:
    ...
    git clone -o <username> git@github.com:<username>/scipy2023_sprints_first_PR
...
If this happens, you can use ``git remote`` to add the main repository as a source you can get changes from:
    ...
    git remote add bsipocz https://github.com/bsipocz/scipy2023_sprints_first_PR
...
### License
Developed for Scipy 2023 by Brigitta Sipőcz &copy; licensed under a
